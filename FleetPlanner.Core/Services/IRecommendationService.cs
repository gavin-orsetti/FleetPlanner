...
/// runs 12 analytical patterns that examine tag coverage, intent distribution, doctrine alignment,
/// crew efficiency, tradeoff suppression, and potency mismatches.</para>
/// </summary>
public interface IRecommendationService
{
    /// <summary>
    /// Generates recommendations from a fully-built fleet graph.
    /// Runs all 12 analytical patterns and returns results sorted by score descending.
    /// </summary>
